...
ALTER TABLE "audit_logs" ADD CONSTRAINT "audit_logs_actor_project_member_fk" FOREIGN KEY ("organization_id","project_id","actor_id") REFERENCES "public"."project_members"("organization_id","project_id","user_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "audit_logs" ADD CONSTRAINT "audit_logs_resource_fk" FOREIGN KEY ("organization_id","project_id","resource_id","resource_type") REFERENCES "public"."audit_resources"("organization_id","project_id","id","resource_type") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "project_members" ADD CONSTRAINT "project_members_organization_user_fk" FOREIGN KEY ("organization_id","user_id") REFERENCES "public"."organization_memberships"("organization_id","user_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
